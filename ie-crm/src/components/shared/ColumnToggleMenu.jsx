...
export default function ColumnToggleMenu({ allColumns, visibleKeys, toggleColumn, showAll, hideAll, resetDefaults, customColumns = [], hiddenFieldIds = [], onToggleCustomColumn }) {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div className="absolute right-0 top-full mt-1 z-50 w-56 max-h-80 overflow-y-auto rounded-lg border border-crm-border bg-crm-card shadow-xl animate-sheet-down">
          {/* Header actions */}
