...
export default function ContactDetail({ contactId, id, onClose, onSave, onRefresh, isSlideOver }) {
  ...
  if (loading) {
    ...
    return (
      <div className="fixed inset-0 z-40 flex justify-end" onClick={onClose}>
        ...
        <div className="w-[500px] bg-crm-panel glass-panel border-l border-crm-border h-full overflow-y-auto animate-slide-in-right" onClick={(e) => e.stopPropagation()}>
          <DetailSkeleton />
        </div>
      </div>
    );
  ...
  return (
    <div className="fixed inset-0 z-40 flex justify-end" onClick={onClose}>
      <div className="absolute inset-0 bg-crm-overlay animate-fade-in" />
      <div className="relative w-[500px] bg-crm-panel glass-panel border-l border-crm-border h-full overflow-y-auto animate-slide-in-right" onClick={(e) => e.stopPropagation()}>
        {content}
      </div>
    </div>
  );
